...
> [!WARNING]
> Recite is pre-release (`0.1.0`). An old `recite` 0.0.1 snapshot exists on crates.io;
...
The [Neovim setup](editor/recite-neovim/README.md) is available directly from a
