...
The current product-level requirements are tracked in the [production spec](https://codeberg.org/plethu/recite/src/branch/main/docs/recite-production-spec.md).
