...
| `crates/recite-lsp/src/features/completion.rs` | 244 | production | lsp/features | review | Feature-specific completion and precedence handling |
...
| `crates/recite-lsp/src/tests.rs` | 463 | test/support | lsp/tests | cohesive | Module aggregator, not production implementation |
