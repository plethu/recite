...
| `crates/recite-lsp/src/workspace.rs` | 345 | production | lsp/workspace | review | #164: document state, feature projection, and generation ownership; refresh and semantic phases are split into focused modules |
...
| `crates/recite-lsp/src/workspace/project_index.rs` | 355 | production | lsp/workspace | cohesive | Saved index, atomic manifest transitions, and shared source-only compatibility enumeration |
