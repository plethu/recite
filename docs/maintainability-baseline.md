...
| `editors/recite-tree-sitter/grammar.js` | 372 | production | tree-sitter/grammar | cohesive | Grammar source owns syntax and recovery rules alongside the named node declarations |
| `editors/vscode/src/controller.js` | 365 | production | vscode/controller | review | #51: controller retains restart coordination, startup projection, and terminal child-failure recovery |
