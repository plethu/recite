...
| `editors/vscode/test/controller-lifecycle.test.mjs` | 373 | test/support | vscode/tests | review | #51: lifecycle, retry budget, and notification nonspam scenarios remain one controller contract suite |
...
| `tests/editor-parity/check.sh` | 465 | test/support | editor-parity/tests | review | Editor parity fixture scenarios remain one executable contract suite |
