...
| `scripts/editor_parity/contract.py` | 426 | tooling | editor-parity/contract | review | #202: editor-parity contract topology and documentation validation remain one checked contract boundary |
...
| `tests/editor-parity/check.sh` | 517 | test/support | editor-parity/tests | review | #202: installed-host and incremental host-evidence fixture scenarios remain one executable editor-parity contract suite; split before another host evidence family |
