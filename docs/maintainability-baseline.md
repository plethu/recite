...
| `tests/editor-parity/check.sh` | 352 | test/support | editor-parity/tests | review | #202: installed-host and incremental host-evidence fixture scenarios remain one executable editor-parity contract suite; split before another host evidence family |
