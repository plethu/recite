...
| `CompiledLine`: `id`, decoded `source_text`, `speaker`, `metadata`, `source_map`, authored `source_text`, `interpolation_bindings`, optional decoded `plural_source_text`, optional authored `plural_source_text` | `V0_LINE_FIELDS` (9) | `MsgLine` | `MsgLine`; bindings, speaker/range/source-map/plural-form validation | `json_dialogue.lines`; core-language fixture and plural round-trip test | §12.2 `CompiledLine` |
| `CompiledChoice`: `id`, decoded `source_text`, `metadata`, `requirement`, `requirement_source_text`, `availability_reason_override`, `target`, `echo`, `source_map`, authored `source_text`, `interpolation_bindings` | `V0_CHOICE_FIELDS` (11) | `MsgChoice` | `MsgChoice`; bindings, requirement, reason, target, echo, and source-map validation | `json_dialogue.choices`; availability-reason fixture | §12.2 `CompiledChoice` |
