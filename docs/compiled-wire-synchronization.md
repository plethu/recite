...
| `CompiledAvailabilityReasonArgValue`: `tag`, `payload` (string-tagged argument value) | `V0_TAGGED_VALUE_FIELDS` (2) | `MsgAvailabilityReasonArgValue` in `compiler/src/wire/messagepack.rs` | `MsgAvailabilityReasonArgValueWrapper` custom visitor in `core/src/compiled/messagepack/wire.rs`; tag and finite-float checks | `json_availability_reason_arg_binding`; availability-reason fixture and runtime tests | §12.2 availability-reason argument value |
