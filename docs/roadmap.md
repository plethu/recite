...
command (#126), the compact ID storage follow-up (#156, PR #233), targeted
compiler phase benchmarks (#166, PR #234), and runtime allocation/clone
pressure measurement (#167, PR #235) are closed. The performance track can now
move into watch rebuild latency stress checks (#168) and comparative benchmark
corpus design (#205). Those remaining measurement and comparison issues feed
the blocked release benchmark baseline profile (#169). The comparative
