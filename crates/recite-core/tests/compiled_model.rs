...
fn v0_wire_constants_lock_main_tuple_and_tag_decisions() {
    ...
    assert_eq!(V0_SCALAR_TAG_STRING, 0);
    assert_eq!(V0_SCALAR_TAG_INTEGER, 1);
    assert_eq!(V0_SCALAR_TAG_FLOAT, 2);
    assert_eq!(V0_SCALAR_TAG_BOOLEAN, 3);
    assert_eq!(V0_VALUE_TAG_SCALAR, 0);
    assert_eq!(V0_VALUE_TAG_ARRAY, 1);
}
