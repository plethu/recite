...
pub use authoring::{
    ...
    PreparedPublishIdentity, PresentationProjectorSummary, ProducerCapabilityStatus,
    ProducerFailureEvidence, ProducerMetadataSummary, ProjectionQueryFunctionSummary,
