...
pub use authoring::{
    ...
    CatalogIdentity, CatalogInput, CatalogMatch, CatalogResolution, CatalogResolutionPolicy,
    CatalogSummary, CatalogSummaryError, CatalogVariant, ClauseKind, CompletionCandidate,
    CompletionCandidateDetail, CompletionCandidateKind, CompletionItem, CompletionSite,
    CompletionSiteKind, ConditionSummary, DiagnosticCollection, DiagnosticIter, DialogueCatalog,
    DialogueCatalogInput, DialogueCatalogSummary, DocumentDelta, DocumentLayer, DocumentMetadata,
    DocumentSnapshot, DocumentVersion, EditPrecondition, EffectSummary, FreshnessAssessment,
    FreshnessSnapshotSide, FreshnessStatus, FunctionReferenceKind, FunctionReferenceSummary,
    HoverInfo, MarkupSummary, MetadataDomainSummary, MetadataKeySummary, MetadataScalar,
    MetadataSummary, MetadataValue, MetadataValueDetail, MetadataValueKind, NavigationResult,
    OpenDocument, PreparedPublishIdentity, PresentationProjectorSummary, ProducerActionDescriptor,
