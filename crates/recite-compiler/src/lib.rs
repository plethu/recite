...
pub use authoring::{
    ...
    BuildTransition, BuildTransitionError, ClauseKind, CompletionCandidate,
    CompletionCandidateDetail, CompletionCandidateKind, CompletionItem, CompletionSite,
    CompletionSiteKind, ConditionSummary, DiagnosticCollection, DiagnosticIter, DocumentDelta,
    DocumentLayer, DocumentMetadata, DocumentSnapshot, DocumentVersion, EditPrecondition,
    EffectSummary, FreshnessAssessment, FreshnessSnapshotSide, FreshnessStatus,
    FunctionReferenceKind, FunctionReferenceSummary, HoverInfo, MarkupSummary,
    ...
    ProducerFailureEvidence, ProducerFingerprintScopes, ProducerLaunchSnapshot,
    ProducerLaunchSnapshotError, ProducerMetadataSummary, ProducerRetryGuidance,
    ProjectionQueryFunctionSummary, PublishAbortReason, PublishFailure, PublishFailureReason,
    PublishNotAttemptedReason, PublishOutcome, PublishOutcomeError, PublishRefusal, QueryClass,
    QueryResult, QueryUnavailableReason, RecoveryNeeded, RegistrySummary, RestartGuidance,
    SavedDocument, SchemaAction, SchemaCapability, SchemaCapabilityUnavailableReason,
    SchemaDeclarationProvenance, SchemaDeclarationSummary, SchemaFingerprintSummary,
    SchemaFreshness, SchemaFreshnessEvidence, SchemaFreshnessSnapshotIdentity,
    ...
    SchemaSummaryEvidenceError, SchemaTypeSummary, SemanticFact, SemanticSymbolKind,
    SnapshotGeneration, SourceEdit, SourceFingerprint, SourceRange, SpeakerSummary, StableIdKind,
    StableIdSummary, StaleReason, SymbolIdentity, SymbolKind, SymbolLocation, SymbolQueryOptions,
    SymbolRole, plan_create_block_stub, plan_create_block_stub_in_range, plan_insert_missing_id,
