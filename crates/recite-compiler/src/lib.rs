...
pub use authoring::{
    ...
    CompletionItem, CompletionSite, CompletionSiteKind, ConditionSummary, DiagnosticCollection,
    DiagnosticIter, DocumentDelta, DocumentLayer, DocumentMetadata, DocumentSnapshot,
    DocumentVersion, EditPrecondition, EffectSummary, FreshnessAssessment, FreshnessStatus,
    ...
    PreparedPublishIdentity, PresentationProjectorSummary, ProducerMetadataSummary,
    ...
    SchemaFreshness, SchemaFreshnessUnavailableReason, SchemaOwnership, SchemaSourceSummary,
    SchemaSummary, SchemaTypeSummary, SemanticFact, SemanticSymbolKind, SnapshotGeneration,
    SourceEdit, SourceFingerprint, SourceRange, SpeakerSummary, StableIdKind, StableIdSummary,
    StaleReason, SymbolIdentity, SymbolKind, SymbolLocation, SymbolQueryOptions, SymbolRole,
