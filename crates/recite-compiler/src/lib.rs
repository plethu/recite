...
pub use authoring::{
    ...
    BuildAuthorityError, BuildAuthorityFence,
    ...
    CompletionItem, CompletionSite, CompletionSiteKind, DiagnosticCollection, DiagnosticIter,
    DocumentDelta, DocumentLayer, DocumentMetadata, DocumentSnapshot, DocumentVersion,
    EditPrecondition, FreshnessAssessment, FreshnessStatus, FunctionReferenceKind, FunctionReferenceSummary,
    HoverInfo, MetadataScalar, MetadataSummary, MetadataValue, MetadataValueDetail,
    MetadataValueKind, NavigationResult, OpenDocument, PreparedPublishIdentity, PublishAbortReason,
    PublishFailure, PublishFailureReason, PublishNotAttemptedReason, PublishOutcome,
    PublishOutcomeError, PublishRefusal, QueryClass, QueryResult, QueryUnavailableReason,
    RecoveryNeeded, RestartGuidance, SavedDocument, SemanticFact, SemanticSymbolKind,
