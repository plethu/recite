...
use recite_core::{Diagnostic, project::ProjectManifestSource, schema::ProjectSchema};
...
/// A complete, validated saved-project build request.
///
...
pub enum ProjectBuildPreparationError {
    ...
    #[error(transparent)]
    Request(#[from] recite_compiler::authoring::BuildRequestError),
    #[error(transparent)]
