...
pub(crate) enum MsgId {
    ...
    TuiDeferredQueueTitle,
    TuiDeferredQueueScheduled,
    TuiDeferredQueueDispatched,
    TuiTranscriptLine,
    TuiTranscriptPrompt,
    TuiTranscriptChoice,
...
impl MsgId {
    pub(crate) const ALL: &'static [Self] = &[
        ...
        Self::TuiDeferredQueueTitle,
        Self::TuiDeferredQueueScheduled,
        Self::TuiDeferredQueueDispatched,
    ...
    pub(crate) fn key(self) -> &'static str {
        match self {
            ...
            Self::TuiDeferredQueueTitle => "tui-deferred-queue-title",
            Self::TuiDeferredQueueScheduled => "tui-deferred-queue-scheduled",
            Self::TuiDeferredQueueDispatched => "tui-deferred-queue-dispatched",
            ...
            Self::TuiHelpActionQueue => "tui-help-action-queue",
            ...
            Self::TuiHelpDescriptionQueue => "tui-help-description-queue",
