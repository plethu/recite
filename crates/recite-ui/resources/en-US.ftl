...
watch-build-failed-partial = watch: build {$status}: partial publication; failed target {$failed}; recovery targets: {$recovery}
watch-build-failed-indeterminate = watch: build {$status}: publication state is indeterminate; recovery targets: {$recovery}
watch-build-failed-refused = watch: build {$status}: publication refused: {$reason}
watch-build-failed-not-attempted = watch: build {$status}: publication not attempted: {$reason}
watch-build-failed-published = watch: build {$status}: publication unexpectedly reported success
watch-build-failed-unsupported = watch: build {$status}: publication returned an unsupported outcome
watch-build-failed-partial-with-failure = watch: build {$status}: partial publication; failed target {$failed}; recovery targets: {$recovery}; {$failure}
watch-build-failed-indeterminate-with-failure = watch: build {$status}: publication state is indeterminate; recovery targets: {$recovery}; {$failure}
watch-build-failed-refused-with-failure = watch: build {$status}: publication refused: {$reason}; {$failure}
watch-build-failed-not-attempted-with-failure = watch: build {$status}: publication not attempted: {$reason}; {$failure}
watch-build-failed-published-with-failure = watch: build {$status}: publication unexpectedly reported success; {$failure}
watch-build-failed-unsupported-with-failure = watch: build {$status}: publication returned an unsupported outcome; {$failure}
