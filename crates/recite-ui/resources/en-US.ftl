...
lsp-client-restart-scheduled = Recite language server restart scheduled in {$milliseconds} milliseconds.
lsp-client-restart-exhausted = Recite language server restart attempts exhausted.
lsp-client-transport-failed = Recite language server transport failed: {$detail}.
lsp-client-protocol-failed = Recite language server protocol failed.
lsp-client-lifecycle-failed = Recite language server lifecycle failed: {$detail}.
...
vscode-command-validate-title = Recite: Validate
vscode-command-compile-title = Recite: Compile
vscode-command-extract-title = Recite: Extract messages
vscode-command-watch-start-title = Recite: Start watch
vscode-command-watch-stop-title = Recite: Stop watch
vscode-command-run-title = Recite: Run fixture
vscode-command-trace-title = Recite: Trace fixture
vscode-command-rename-title = Recite: Rename block
vscode-command-rename-command-title = Recite: Rename block
...
vscode-command-rename-request-failed = Recite block rename failed: {$detail}.
vscode-command-cli-path-description = Executable used for local Recite commands. A bare name is resolved through PATH; a path is resolved relative to the project root.
...
vscode-command-result = Recite command completed: {$detail}
vscode-command-content-diagnostics = Recite found content diagnostics: {$detail}
vscode-command-failure = Recite command failed: {$detail}
vscode-command-protocol-failure = Recite command protocol failed: {$detail}
vscode-command-watch-status = Recite watch status: {$detail}
