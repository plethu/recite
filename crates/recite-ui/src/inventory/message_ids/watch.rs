pub(super) const fn key(id: super::MsgId) -> Option<&'static str> {
    match id {
        ...
        super::MsgId::WatchBuildDurationMicroseconds => Some("watch-build-duration-microseconds"),
        super::MsgId::WatchBuildDurationMilliseconds => Some("watch-build-duration-milliseconds"),
