...
impl Icon {
    ...
    pub(crate) fn colored(self, color: Color) -> Element {
        let shape = match self {
            ...
            Self::Settings => {
                "<circle cx='12' cy='12' r='3'/><polygon points='8.83,5.20 9.92,2.22 14.08,2.22 15.17,5.20 16.30,5.86 19.43,5.31 21.51,8.91 19.47,11.35 19.47,12.65 21.51,15.09 19.43,18.69 16.30,18.14 15.17,18.80 14.08,21.78 9.92,21.78 8.83,18.80 7.70,18.14 4.57,18.69 2.49,15.09 4.53,12.65 4.53,11.35 2.49,8.91 4.57,5.31 7.70,5.86'/>"
            }
